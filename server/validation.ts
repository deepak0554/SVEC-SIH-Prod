...
export const teamRegistrationSchema = z.object({
  ...
  paymentStatus: z.enum(["free", "paid", "pending", "pending_verification", "rejected"]).optional(),
  paymentMode: z.enum(["gateway", "manual_upi", "free"]).optional(),
  paymentProofUrl: z.string().max(1000).optional().or(z.literal("")),
  paymentProofFileName: z.string().max(255).optional().or(z.literal("")),
  paymentProofBase64: z.string().max(25 * 1024 * 1024).optional().or(z.literal("")),
  upiTransactionId: z.string().trim().max(100).optional().or(z.literal("")),
  paymentRemarks: z.string().max(2000).optional().or(z.literal("")),
  paymentVerifiedBy: z.string().max(150).optional().or(z.literal("")),
  paymentVerifiedAt: z.string().max(100).optional().or(z.literal("")),
...
export const updateRegistrationAdminSchema = z.object({
  ...
  studentEmail: optionalEmailSchema,
  paymentStatus: z.enum(["pending", "pending_verification", "paid", "free", "rejected"]).optional(),
  paymentMode: z.enum(["gateway", "manual_upi", "free"]).optional(),
  paymentProofUrl: z.string().max(1000).optional().or(z.literal("")),
  paymentProofFileName: z.string().max(255).optional().or(z.literal("")),
  paymentProofBase64: z.string().max(25 * 1024 * 1024).optional().or(z.literal("")),
...
export const settingsSchema = z.object({
  ...
  paymentMode: z.enum(["gateway", "manual_upi", "both", "free"]).optional(),
  manualPaymentEnabled: z.boolean().optional(),
  upiQrCodeUrl: z.string().max(35 * 1024 * 1024).optional().or(z.literal("")),
  upiId: z.string().trim().max(100).optional().or(z.literal("")),
  upiPayeeName: z.string().trim().max(150).optional().or(z.literal("")),
  upiInstructions: z.string().max(3000).optional().or(z.literal("")),
  requirePaymentScreenshot: z.boolean().optional(),
  ...
  logoUrl: z.string().max(35 * 1024 * 1024).optional().or(z.literal("")),
  ...
  certificateBgUrl: z.string().max(35 * 1024 * 1024).optional().or(z.literal("")),
  ...
  consentLetterSignatureUrl: z.string().max(35 * 1024 * 1024).optional().or(z.literal("")),
  consentLetterStampUrl: z.string().max(35 * 1024 * 1024).optional().or(z.literal("")),
